            ...
            if (firstNode != null && secondNode != null) {
                if (isLastNodeAttribute) { // Last node is an attribute in the target
                    ...
                    if (secondNode.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        System.out.println(secondPath + " == secondPathParts002 : " +secondElement.hasChildNodes());
...
//                        }
                    ...
                    if (secondNode.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        System.out.println(firstPath + " == secondPathParts2 : " +secondElement.hasChildNodes());
                        System.out.println("secondElement ::" + secondElement.getNodeName() + "--" + secondElement.getNodeValue());
